...
public class changeListName extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        listNameChangeLabel.setFont(new java.awt.Font("Tahoma 36", 1, 36)); // NOI18N
        ...
        listNameChangeLabel.setText("Change List Name");
        listNameChangeLabel.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        listNameChangeLabel.setName("listNameChangeLabel"); // NOI18N

        cancelButton.setBackground(new java.awt.Color(102, 102, 102));
        cancelButton.setFont(new java.awt.Font("Tahoma 18 18 12 18", 1, 18));
        ...
        confirmButton.setFont(new java.awt.Font("Tahoma 18 18 12 18", 1, 18));
        confirmButton.setForeground(new java.awt.Color(255, 255, 255));
        confirmButton.setText("Confirm");
        confirmButton.setActionCommand("cancelAccountButton");
        confirmButton.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED), null));
        ...
        listNameField.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        listNameField.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        listNameField.setName("listNameField"); // NOI18N
        listNameField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                listNameFieldActionPerformed(evt);
            }
        });

        origionalListNameLabel.setBackground(new java.awt.Color(51, 51, 51));
        origionalListNameLabel.setFont(new java.awt.Font("Tahoma", 1, 14));
        origionalListNameLabel.setForeground(new java.awt.Color(255, 255, 0));
        origionalListNameLabel.setName("origionalListNameLabel"); // NOI18N

        currentListLabel.setBackground(new java.awt.Color(51, 51, 51));
        currentListLabel.setFont(new java.awt.Font("Tahoma", 1, 18));
        currentListLabel.setForeground(new java.awt.Color(255, 255, 255));
        currentListLabel.setText("Current Name:");
        currentListLabel.setName("currentListLabel"); // NOI18N

        newListNameLabel.setBackground(new java.awt.Color(51, 51, 51));
        newListNameLabel.setFont(new java.awt.Font("Tahoma", 1, 14));
        ...
        changeListPanelLayout.setHorizontalGroup(
            ...
            .addGroup(changeListPanelLayout.createSequentialGroup()
                ...
                .addGroup(changeListPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(listNameChangeLabel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(changeListPanelLayout.createSequentialGroup()
                    ...
                    .addGroup(changeListPanelLayout.createSequentialGroup()
                        .addGroup(changeListPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(newListNameLabel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(currentListLabel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(changeListPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(origionalListNameLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 176, Short.MAX_VALUE)
                            .addComponent(listNameField, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap())
        );
        ...
        setBounds((screenSize.width-353)/2, (screenSize.height-268)/2, 353, 268);
    ...
    private void confirmButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmButtonActionPerformed
        if(evt.getSource() == confirmButton)
		{
			...
			else
			{
				...
				//Returns to List
				new itemListView(user, newName, mDBApi);
				setVisible(false);
                                dispose();
			}
		}
    ...
    private void listNameFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_listNameFieldActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_listNameFieldActionPerformed
